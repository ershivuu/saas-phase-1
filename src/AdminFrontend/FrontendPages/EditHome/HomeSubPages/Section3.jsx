...
function Section3() {
  const [boxNo, setBoxNo] = useState(""); // Initial value empty
  const [selectedField, setSelectedField] = useState(""); // Initial value empty
                ...
                selectedField !== "box_img" && (
                  <div>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        setFormData({ ...formData, [selectedField]: e.target.value })
                      }
                      required
                    />
                  </div>
              ...
              {selectedField === "box_img" && (
                <div>
                  ...
                  <input
                    ...
                    onChange={(e) => setFormData({ ...formData, box_img: e.target.files[0] })}
                    required
                  />
