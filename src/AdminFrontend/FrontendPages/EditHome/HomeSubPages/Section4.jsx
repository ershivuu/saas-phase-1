...
import { updateSection4, getSection4Data } from "../../../FrontendServices"; // Update the import to match your file structure
...
function Section4() {
  ...
  const [formData, setFormData] = useState({
    ...
    header_3: "",
    box_content: "",
    bg_col: "#ffffff", // Default color is white
    image: null,
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const box_no = boxNo; // Use boxNo state instead of form input
